				...
				<div className=" flex flex-row justify-between lg:justify-evenly items-center px-4 lg:px-8">
					...
					<nav className="lg:flex hidden">
						<nav
							...
							dir="ltr"
							className="relative z-10 flex max-w-max flex-1 items-center justify-center text-4xl"
						>
							<div className="position:relative" id="navbar-default">
								<ul
									data-orientation="horizontal"
									className="gap-6 group flex flex-1 list-none items-center justify-center space-x-1"
									dir="ltr"
								>
									<li>
					...
					<div className="max-w-2xl flex flex-row gap-4">
						...
						<div className="sm:flex flex-row gap-4 items-center hidden text-lg">
							<Link
								href="/contact"
								className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-gray-900 text-primary-foreground hover:bg-Gray-800 h-10 px-4 py-2"
							>
								Contact Me
							</Link>
						</div>
