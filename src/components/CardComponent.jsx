...
const CardComponent = () => {
    const dataCard = [
...

        {
            ...
            description: "I develop Android applications using Kotlin and Jetpack Compose, focusing on modern, efficient, and user-friendly UI designs."
        },
        {
            ...
            title: "Web Design",
            description: "I have experience in web design using HTML, CSS, and Tailwind CSS, creating visually appealing and responsive user interfaces."
        },
        {
            image: <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5V19A9 3 0 0 0 21 19V5"></path><path d="M3 12A9 3 0 0 0 21 12"></path></svg>,
            title: "Database",
            description: "I have experience in designing and managing databases using PostgreSQL, ensuring efficient data organization and optimized performance."
        },
        {
